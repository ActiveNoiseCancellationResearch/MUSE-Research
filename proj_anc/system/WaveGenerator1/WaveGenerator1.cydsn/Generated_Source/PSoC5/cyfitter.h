...
/* End_isr */
#define End_isr__0__MASK 0x40u
#define End_isr__0__PC CYREG_PRT0_PC6
#define End_isr__0__PORT 0u
#define End_isr__0__SHIFT 6
#define End_isr__AG CYREG_PRT0_AG
#define End_isr__AMUX CYREG_PRT0_AMUX
#define End_isr__BIE CYREG_PRT0_BIE
#define End_isr__BIT_MASK CYREG_PRT0_BIT_MASK
#define End_isr__BYP CYREG_PRT0_BYP
#define End_isr__CTL CYREG_PRT0_CTL
#define End_isr__DM0 CYREG_PRT0_DM0
#define End_isr__DM1 CYREG_PRT0_DM1
#define End_isr__DM2 CYREG_PRT0_DM2
#define End_isr__DR CYREG_PRT0_DR
#define End_isr__INP_DIS CYREG_PRT0_INP_DIS
#define End_isr__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define End_isr__LCD_EN CYREG_PRT0_LCD_EN
#define End_isr__MASK 0x40u
#define End_isr__PORT 0u
#define End_isr__PRT CYREG_PRT0_PRT
#define End_isr__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define End_isr__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define End_isr__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define End_isr__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define End_isr__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define End_isr__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define End_isr__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define End_isr__PS CYREG_PRT0_PS
#define End_isr__SHIFT 6
#define End_isr__SLW CYREG_PRT0_SLW

/* Start_isr */
#define Start_isr__0__MASK 0x20u
#define Start_isr__0__PC CYREG_PRT0_PC5
#define Start_isr__0__PORT 0u
#define Start_isr__0__SHIFT 5
#define Start_isr__AG CYREG_PRT0_AG
#define Start_isr__AMUX CYREG_PRT0_AMUX
#define Start_isr__BIE CYREG_PRT0_BIE
#define Start_isr__BIT_MASK CYREG_PRT0_BIT_MASK
#define Start_isr__BYP CYREG_PRT0_BYP
#define Start_isr__CTL CYREG_PRT0_CTL
#define Start_isr__DM0 CYREG_PRT0_DM0
#define Start_isr__DM1 CYREG_PRT0_DM1
#define Start_isr__DM2 CYREG_PRT0_DM2
#define Start_isr__DR CYREG_PRT0_DR
#define Start_isr__INP_DIS CYREG_PRT0_INP_DIS
#define Start_isr__LCD_COM_SEG CYREG_PRT0_LCD_COM_SEG
#define Start_isr__LCD_EN CYREG_PRT0_LCD_EN
#define Start_isr__MASK 0x20u
#define Start_isr__PORT 0u
#define Start_isr__PRT CYREG_PRT0_PRT
#define Start_isr__PRTDSI__CAPS_SEL CYREG_PRT0_CAPS_SEL
#define Start_isr__PRTDSI__DBL_SYNC_IN CYREG_PRT0_DBL_SYNC_IN
#define Start_isr__PRTDSI__OE_SEL0 CYREG_PRT0_OE_SEL0
#define Start_isr__PRTDSI__OE_SEL1 CYREG_PRT0_OE_SEL1
#define Start_isr__PRTDSI__OUT_SEL0 CYREG_PRT0_OUT_SEL0
#define Start_isr__PRTDSI__OUT_SEL1 CYREG_PRT0_OUT_SEL1
#define Start_isr__PRTDSI__SYNC_OUT CYREG_PRT0_SYNC_OUT
#define Start_isr__PS CYREG_PRT0_PS
#define Start_isr__SHIFT 5
#define Start_isr__SLW CYREG_PRT0_SLW
