...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=1, VDAC_Range=0, VDAC_Speed=0, Voltage=400, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_1_hs, CY_INSTANCE_SHORT_NAME=VDAC8_1_hs, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=VDAC8_1_hs, )
...
// ADC_SAR_v3_0(ADC_Clock=1, ADC_Clock_Frequency=1000000, ADC_Input_Range=0, ADC_Power=0, ADC_Reference=0, ADC_Resolution=12, ADC_SampleMode=2, Enable_next_out=false, Ref_Voltage=1.024, Ref_Voltage_mV=1024, rm_int=false, Sample_Precharge=4, Sample_Rate=62500, Sample_Rate_def=631579, CY_COMPONENT_NAME=ADC_SAR_v3_0, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=ADC_SAR, CY_INSTANCE_SHORT_NAME=ADC_SAR, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=ADC_SAR, )
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=1, VDAC_Range=0, VDAC_Speed=0, Voltage=400, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=VDAC8_2_ls, CY_INSTANCE_SHORT_NAME=VDAC8_2_ls, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.2, INSTANCE_NAME=VDAC8_2_ls, )
...
module top ;
    ...
    VDAC8_v1_90_0 VDAC8_1_hs (
        .strobe(Net_48),
        .data(8'b00000000),
        .vOut(Net_34));
    defparam VDAC8_1_hs.Data_Source = 0;
    defparam VDAC8_1_hs.Initial_Value = 100;
    defparam VDAC8_1_hs.Strobe_Mode = 1;
    ...
    VDAC8_v1_90_2 VDAC8_2_ls (
        .strobe(Net_48),
        .data(8'b00000000),
        .vOut(Net_92));
    defparam VDAC8_2_ls.Data_Source = 0;
    defparam VDAC8_2_ls.Initial_Value = 100;
    defparam VDAC8_2_ls.Strobe_Mode = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("df7b5aba-e3e9-4418-9d40-76a83a2fa114"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Start_isr_net;
	wire [0:0] tmpFB_0__Start_isr_net;
	wire [0:0] tmpIO_0__Start_isr_net;
	wire [0:0] tmpINTERRUPT_0__Start_isr_net;
	electrical [0:0] tmpSIOVREF__Start_isr_net;

	cy_psoc3_pins_v1_10
		#(.id("d7449480-d015-462e-a171-62862bc40e78"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Start_isr
		 (.oe(tmpOE__Start_isr_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Start_isr_net[0:0]}),
		  .io({tmpIO_0__Start_isr_net[0:0]}),
		  .siovref(tmpSIOVREF__Start_isr_net),
		  .interrupt({tmpINTERRUPT_0__Start_isr_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Start_isr_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__End_isr_net;
	wire [0:0] tmpFB_0__End_isr_net;
	wire [0:0] tmpIO_0__End_isr_net;
	wire [0:0] tmpINTERRUPT_0__End_isr_net;
	electrical [0:0] tmpSIOVREF__End_isr_net;

	cy_psoc3_pins_v1_10
		#(.id("a3f55bbd-b075-4c9a-99a3-52beb257637e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		End_isr
		 (.oe(tmpOE__End_isr_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__End_isr_net[0:0]}),
		  .io({tmpIO_0__End_isr_net[0:0]}),
		  .siovref(tmpSIOVREF__End_isr_net),
		  .interrupt({tmpINTERRUPT_0__End_isr_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__End_isr_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
